...
export class Backend implements backendInterface {
    ...
    async addTutor(arg0: TutorProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTutor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteCourse(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteCourse();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteTutor(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteTutor();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteVideo(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteVideo();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAcademyInfo(): Promise<Array<AcademyProfile>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAcademyInfo();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getContacts(): Promise<Array<Enrollment>> {
        if (this.processError) {
            try {
    ...
    async getExternalBlobs(): Promise<Array<[string, ExternalBlob]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getExternalBlobs();
    ...
    async getTutors(): Promise<Array<TutorProfile>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTutors();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveExternalBlob(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveExternalBlob(arg0, await to_candid_ExternalBlob_n16(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitContact(arg0: Enrollment): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateAcademyInfo(arg0: AcademyProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAcademyInfo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTutor(arg0: TutorProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTutor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
